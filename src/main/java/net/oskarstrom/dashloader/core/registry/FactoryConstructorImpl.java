...
public class FactoryConstructorImpl<F, D extends Dashable<F>> implements FactoryConstructor<F, D> {
	...
	public static <F, D extends Dashable<F>> FactoryConstructor<F, D> createConstructor(Class<F> rawClass, Class<D> dashClass) throws IllegalAccessException, NoSuchMethodException {
